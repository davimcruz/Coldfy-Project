    ...
    <section className="section small" style={sectionStyle}>
      <div className="lp-layout-blockcontainer container lp-container">
        <div className="w-layout-grid three-grid">
          <div animation-id="firstServiceAnimation" style={cardStyle} className="card large">
            <div className="card-content-wrapper vertical-w-icon" style={cardContentStyle}>
          ...
          <div animation-id="secondServiceAnimation" style={cardStyle} className="card large">
            <div className="card-content-wrapper vertical-w-icon" style={cardContentStyle}>
              <div className="flex-wrapper---horizontal">
          ...
          <div animation-id="thirdServiceAnimation" style={cardStyle} className="card large">
            <div className="card-content-wrapper vertical-w-icon" style={cardContentStyle}>
              <div className="flex-wrapper---horizontal ">
